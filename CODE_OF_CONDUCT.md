...
possible violation, email **aahilminookhan@gmail.com** with the subject
`[Holt conduct]`. Reports are received privately by the maintainer and treated
as confidential. Please do not file a public GitHub issue for a Code of Conduct
concern; doing so may amplify harm to the people involved.

Reports will be taken seriously and investigated as promptly as practical.
Investigation may include reviewing messages, logs, and recordings or speaking
with witnesses and other participants. Investigation and enforcement actions
will be kept as transparent as possible while prioritizing safety and
confidentiality. Enforcement is normally carried out privately with the
involved parties, though communicating to the community may be part of a
...
1. **Warning**
   ...
   - **Consequence:** A private, written warning from maintainers and
     moderators.
...
2. **Temporarily Limited Activities**
   ...
   - **Repair:** Examples include making an apology, reflecting on actions and
     impact, and returning thoughtfully after the cooldown.
...
4. **Permanent Ban**
   - **Event:** Repeated violations that other steps have failed to resolve, or
     a violation so serious that the community cannot be kept safe with this
     person as a member.
...
This enforcement ladder is a guideline. It does not limit maintainers' and
moderators' ability to use discretion and judgment in the community's best
interests.
...
team. Answers to common questions, translations, and additional resources are
available from the [Contributor Covenant
