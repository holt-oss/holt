...
test("counts down in September", () => {
  assert.deepEqual(at("2026-09-25T12:00:00Z"), { live: false, text: "Hacktoberfest 2026 starts in 6 days." });
  assert.equal(at("2026-09-30T23:59:59Z")?.text, "Hacktoberfest 2026 starts in 1 day.");
});

test("is on from 1 to 31 October", () => {
  assert.deepEqual(at("2026-10-01T00:00:00Z"), { live: true, text: "Hacktoberfest is on. 31 days left." });
